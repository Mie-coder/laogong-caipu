...
export function ImportFlow() {
  ...
  useEffect(() => { if (state.stage === "recipeConfirm" && state.dirty) window.sessionStorage.setItem(STORAGE_KEY, JSON.stringify(state)); }, [state]);
