...
export function ImageReviewScreen({ urls, selectedUrls, coverUrl, onBack, onToggle, onCover, onConfirm }: ImageReviewScreenProps) {
  return <main data-testid="image-review-page" data-transaction-screen="true" className="image-review-page mx-auto min-h-dvh max-w-[430px] pb-28">
    ...
    <div className="px-5 pt-4"><ImageCarousel images={urls} selectedUrls={selectedUrls} coverUrl={coverUrl} onToggleSelection={onToggle} onSetCover={onCover} variant="imageReview" reviewLabel={`所有解析图片  共 ${urls.length} 张`} /></div>
